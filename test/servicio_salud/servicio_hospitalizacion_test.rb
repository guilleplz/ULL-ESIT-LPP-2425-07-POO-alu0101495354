...
class ServicioHospitalizacionTest < Test::Unit::TestCase
  ...
  def setup
    @servicio = ServicioHospitalizacion.new(1, "hospital", Hora.new(8, 0, 0), Hora.new(20, 0, 30), [Fecha.new(2024, 1, 1), Fecha.new(2024, 12, 6)], 1, 8)
    ...
    @servicio.asignar_paciente_a_cama(nil, 1, Fecha.new(2024, 1, 1), Hora.new(8, 0, 0), Fecha.new(2024, 1, 2), Hora.new(8, 0, 0))
  end
