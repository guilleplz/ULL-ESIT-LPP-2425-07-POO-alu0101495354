...
class ServicioSaludTest < Test::Unit::TestCase
  def setup
    @servicio = ServicioSalud.new(1, "hospital", Hora.new(8, 0, 0), Hora.new(20, 0, 30), [Fecha.new(2024, 1, 1), Fecha.new(2024, 12, 6)], 10)
  ...
  def test_asignar_medico_a_paciente
    @servicio.asignar_paciente_a_cama(@paciente, 1, Fecha.new(2020, 1, 1), Hora.new(8, 0, 0), Fecha.new(2020, 1, 2), Hora.new(8, 0, 0))
    assert_equal @paciente, @servicio.camas_estandar[1][:paciente]
  ...
  def test_asignar_paciente_a_cama
    @servicio.asignar_paciente_a_cama(@paciente, 1, Fecha.new(2020, 1, 1), Hora.new(8, 0, 0), Fecha.new(2020, 1, 2), Hora.new(8, 0, 0))
    assert_equal@paciente, @servicio.camas_estandar[1][:paciente]
    assert_raise(RuntimeError) { @servicio.asignar_paciente_a_cama(@paciente, 1, Fecha.new(2020, 1, 1), Hora.new(8, 0, 0), Fecha.new(2020, 1, 2), Hora.new(8, 0, 0)) }
  end

  def test_duracion_ocupacion_cama
    @servicio.asignar_paciente_a_cama(@paciente, 1, Fecha.new(2020, 1, 1), Hora.new(8, 0, 0), Fecha.new(2020, 1, 2), Hora.new(8, 0, 0))
    assert_equal 1, @servicio.duracion_ocupacion_cama(1)
  end

  def test_comparison
    servicio2 = ServicioSalud.new(2, "hospital2", Hora.new(8, 0, 0), Hora.new(20, 0, 30), [Fecha.new(2024, 1, 1), Fecha.new(2024, 12, 6)], 10)
  ...
  def test_numero_pacientes_asignados
    ...
    @servicio.asignar_paciente_a_cama(@paciente, 2, Fecha.new(2020, 1, 1), Hora.new(8, 0, 0), Fecha.new(2020, 1, 2), Hora.new(8, 0, 0))
